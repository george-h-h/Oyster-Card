...
- Now let's check the version of Ruby we have installed. You can find out the latest stable Ruby version on [its website](https://www.ruby-lang.org/en/downloads/).

**NOTE: When following the instructions below, replace 3.1.0 with the latest stable ruby version, whatever that may be.**

- As of today, it's 3.1.0. Assuming you have RVM installed (if not, follow the instructions from the [RVM website](https://rvm.io/rvm/install), run `rvm list` to see what Ruby version you have on your machine. The output will look similar to this:
...
If you can't see the latest Ruby version there, you'll need to install it using `rvm install 3.1.0`. Once done, verify it's successfully installed by running `ruby -v` – you will see the Ruby version.
...
Add this line to Gemfile after `source`: `ruby '<version number>'` replacing `<version number>` with the latest ruby version.

- Now your Gemfile looks something like this:
...
[😫](https://airtable.com/shrUJ3t7KLMqVRFKR?prefill_Repository=makersacademy/course&prefill_File=oystercard/walkthroughs/01_create_gemfile.md&prefill_Sentiment=😫) [😕](https://airtable.com/shrUJ3t7KLMqVRFKR?prefill_Repository=makersacademy/course&prefill_File=oystercard/walkthroughs/01_create_gemfile.md&prefill_Sentiment=😕) [😐](https://airtable.com/shrUJ3t7KLMqVRFKR?prefill_Repository=makersacademy/course&prefill_File=oystercard/walkthroughs/01_create_gemfile.md&prefill_Sentiment=😐) [🙂](https://airtable.com/shrUJ3t7KLMqVRFKR?prefill_Repository=makersacademy/course&prefill_File=oystercard/walkthroughs/01_create_gemfile.md&prefill_Sentiment=🙂) [😀](https://airtable.com/shrUJ3t7KLMqVRFKR?prefill_Repository=makersacademy/course&prefill_File=oystercard/walkthroughs/01_create_gemfile.md&prefill_Sentiment=😀)  
